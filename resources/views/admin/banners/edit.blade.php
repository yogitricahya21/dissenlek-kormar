            ...
            <div class="p-6 bg-white shadow-sm sm:rounded-lg">
                <form action="{{ route('admin.banners.update', $banner->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                        ...
                        <div class="mb-4">
                            <label class="block font-bold text-gray-700">Eyebrow Text:</label>
                            <input type="text" name="eyebrow_text" value="{{ $banner->eyebrow_text }}"
                        ...
                        <div class="mb-4">
                            ...
                            <select name="media_type" class="w-full p-2 border rounded">
                                <option value="image" {{ $banner->media_type == 'image' ? 'selected' : '' }}>Gambar
                                    (.jpg, .png)</option>
                                <option value="video" {{ $banner->media_type == 'video' ? 'selected' : '' }}>Video
                                    (.mp4)</option>
                            </select>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" name="order_index" value="{{ $banner->order_index }}"
                                class="w-full p-2 border rounded">
                        </div>
                    </div>
                    ...
                    <div class="mt-4 mb-4">
                        ...
                        <div class="p-2 mt-2 border rounded bg-gray-50">
                            ...
                            @else
                                <img src="{{ asset('assets/img/banner/' . $banner->media_file) }}"
                                    class="h-32 rounded shadow-md">
                            @endif
                        </div>
                        <label class="block mt-4 text-sm italic font-bold text-gray-700 underline">Ganti File (Kosongkan
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="stroke_text" value="{{ $banner->stroke_text }}"
                            class="w-full p-2 border rounded">
                    </div>

                    <div class="p-4 mt-4 mb-4 border rounded bg-blue-50">
                        <h3 class="mb-2 font-bold text-blue-800">Tombol Utama (Filled)</h3>
                        <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                            <div>
                                <label class="block text-sm">Teks:</label>
                                <input type="text" name="btn_fill_text" value="{{ $banner->btn_fill_text }}"
                                    class="w-full p-2 border rounded">
                            </div>
                            <div>
                                <label class="block text-sm">URL:</label>
                                <input type="text" name="btn_fill_url" value="{{ $banner->btn_fill_url }}"
                                    class="w-full p-2 border rounded">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="p-4 mb-4 border rounded bg-gray-50">
                        <h3 class="mb-2 font-bold text-gray-800">Tombol Kedua (Border)</h3>
                        <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                            <div>
                                <label class="block text-sm">Teks:</label>
                                <input type="text" name="btn_border_text" value="{{ $banner->btn_border_text }}"
                                    class="w-full p-2 border rounded">
                            </div>
                            <div>
                                <label class="block text-sm">URL:</label>
                                <input type="text" name="btn_border_url" value="{{ $banner->btn_border_url }}"
                                    class="w-full p-2 border rounded">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center justify-between pt-4 mt-6 border-t">
                        ...
                        <a href="{{ route('admin.banners.index') }}" class="text-gray-500 hover:text-gray-800">Batal</a>
                    </div>
                </form>
            </div>
        </div>
