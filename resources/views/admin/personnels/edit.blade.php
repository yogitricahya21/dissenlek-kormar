            ...
            <div class="p-6 overflow-hidden bg-white shadow-sm sm:rounded-lg">
                <form action="{{ route('admin.personnels.update', $personnel->id) }}" method="POST"
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="nrp" value="{{ $personnel->nrp }}"
                            class="w-full px-3 py-2 border rounded" required>
                    </div>

                    <div class="mb-4">
                        <label class="block mb-2 text-sm font-bold">Pangkat:</label>
                        <input type="text" name="rank" value="{{ $personnel->rank }}"
                            class="w-full px-3 py-2 border rounded" required>
                    </div>

                    <div class="mb-4">
                        <label class="block mb-2 text-sm font-bold">Jabatan:</label>
                        <input type="text" name="position" value="{{ $personnel->position }}"
                            class="w-full px-3 py-2 border rounded" required>
                    </div>
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <a href="{{ route('admin.personnels.index') }}" class="text-gray-600">Batal</a>
                    </div>
                </form>
            </div>
        </div>
