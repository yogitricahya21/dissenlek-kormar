...
<body>
    ...
    <main>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8">
                        <div class="page-title-wrapper">
                            <h1 class="page-title mb-10">404 error</h1>
                        </div>
        ...
        <!-- error area start  -->
        <div class="error-area pt-130 pb-130 white-bg p-relative z-index-2">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="error-content-wrapper">
                            ...
                            <div class="error-btn">
                                <a href="index.html" class="border-btn">back to home<i
                                        class="flaticon-040-right"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
